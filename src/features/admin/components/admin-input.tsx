    ...
    return (
        <div>
            ...
            <div className="relative">
                {prefix && (
                    <span
                        className={`pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-sm font-bold ${disabled ? 'text-slate-400' : 'text-slate-600'
                            }`}
                    >
                        {prefix}
                    </span>
                ...
                <input
                    ...
                    className={[
                        compact
                            ? 'h-10 rounded-xl'
                            : 'h-12 rounded-2xl',
                        'w-full border bg-[#FBF7EE] text-sm font-semibold text-slate-950 outline-none transition',
