    ...
    return (
        ...
        <main className="min-h-screen bg-[#f8f6f6] text-slate-900">
            <div className="mx-auto w-full max-w-7xl bg-[#f8f6f6] pb-28">
                <section className="relative -mt-[env(safe-area-inset-top)] h-[calc(230px+env(safe-area-inset-top))] w-full overflow-hidden bg-[#0b0907] md:mt-0 md:h-80 lg:h-[420px]">
                    <img
                        src={heroImage}
                        alt={businessName}
                    ...
                    <div className="absolute left-4 right-4 top-[calc(1rem+env(safe-area-inset-top))] z-10 flex items-center justify-between md:left-6 md:right-6 md:top-6 lg:left-8 lg:right-8">
                        <Link
                            href={`/b/${businessSlug}?tab=services`}
                            className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/25 bg-black/30 text-white shadow-[0_12px_30px_rgba(0,0,0,0.32)] backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:bg-white hover:text-slate-950 active:translate-y-0 active:scale-95"
                            aria-label="Volver"
                        >
                        ...
                        <a
                            ...
                            className="group inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/25 bg-black/30 text-white shadow-[0_12px_30px_rgba(0,0,0,0.32)] backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:bg-white hover:text-slate-950 active:translate-y-0 active:scale-95 md:w-auto md:px-4"
